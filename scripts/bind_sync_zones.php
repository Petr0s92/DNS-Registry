...
$CONF['control_panel_url'] = 'http://old.cha0s.awmn/dns/index.php?fetch_slaves_tlds=1';
...
$zones = $db->query("SELECT name, type FROM zones WHERE name NOT IN ( ".SQLite3::escapeString($zone_names)." ) ");
if(!$zones){
